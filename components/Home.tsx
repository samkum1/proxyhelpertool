...
import { Globe, ArrowRight, Shield, Search, Calendar, Zap, HelpCircle, Lock } from 'lucide-react'
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-32 pt-24 ">
        <div className="text-center mb-16 sm:mb-20 pt-8">
          <div className="mb-6 flex justify-center">
            <img src="/lightning-proxies-logo.svg" alt="Lightning Proxies" className="h-10 sm:h-12 w-auto mb-5" />
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 mb-16 sm:mb-20">
          <Link href="/proxy" className="bg-gray-50 rounded-2xl p-6 sm:p-8 border border-gray-200 hover:shadow-lg transition-all duration-300 cursor-pointer group block">
          ...
          <Link href="/fraud" className="bg-gray-50 rounded-2xl p-6 sm:p-8 border border-gray-200 hover:shadow-lg transition-all duration-300 cursor-pointer group block">
            <div className="flex flex-col items-center text-center mb-6">
        ...
        <div className="mb-16 sm:mb-20">
          <div className="text-center mb-12">
            <span className="inline-block text-sm font-semibold text-[#96085D] uppercase tracking-wider mb-3">Benefits</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900">Super-charge your proxy operations with our proxy network</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 border border-gray-200">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Reliable Infrastructure</h3>
              <p className="text-gray-600 mb-6 leading-relaxed text-sm sm:text-sm">Global datacenters across Europe, North America, and Asia guarantee 99% uptime and the fastest response times for any proxy IP.</p>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 border border-gray-200">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Proxy solutions you can rely on</h3>
              <p className="text-gray-600 mb-6 leading-relaxed text-sm sm:text-sm">Choose from our range of proxy products that best suit your use case. Unsure which one to select? No worries — contact sales team.</p>
              <div className="bg-white rounded-xl p-4 border border-gray-200">
                <div className="flex items-center gap-3 mb-3">
                  <div className="grid py-3 grid-cols-5 gap-2 flex-1">
                    <div className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center"><Lock className="w-5 h-5 text-gray-600" /></div>
                    <div className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center"><Globe className="w-5 h-5 text-gray-600" /></div>
                    <div className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center"><Zap className="w-5 h-5 text-gray-600" /></div>
                    <div className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center"><Shield className="w-5 h-5 text-gray-600" /></div>
                    <div className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center"><Search className="w-5 h-5 text-gray-600" /></div>
                  </div>
        ...
        <div className="bg-gray-50 rounded-2xl p-6 sm:p-8 border border-gray-200">
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-4"><Zap className="w-8 h-8 text-white" /></div>
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Fast & Reliable</h4>
              <p className="text-gray-600 text-sm sm:text-base">Lightning-fast proxy checking and fraud detection with reliable infrastructure.</p>
            </div>
          </div>
        </div>
      </div>
